...
import com.example.there.multifeeds.databinding.CategoryListItemBinding
...
class CategoryVideosAdapter(
        private val videos: ObservableList<PlaylistItem>,
        private val videoCategoriesAdapter: VideoCategoriesAdapter,
        @LayoutRes private val videoItemLayoutId: Int,
        @LayoutRes private val categoryListItemLayoutId: Int,
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            CATEGORY_LIST_VIEW_TYPE ->
                BaseBindingViewHolder(parent!!.makeBinding<CategoryListItemBinding>(categoryListItemLayoutId).apply {
                    adapter = videoCategoriesAdapter
                    categoryListItemRecyclerView.layoutManager = LinearLayoutManager(root.context, LinearLayoutManager.HORIZONTAL, false)
                })
        ...
        when (position) {
            ...
            in 1..videos.size -> {
                ...
                videoViewHolder?.let {
                    ...
                    it.binding.root.setOnClickListener { videoClicked.onNext(video.videoId) }
                }
            }
            videos.size + 1 -> {
    ...
    companion object {
        private const val CATEGORY_LIST_VIEW_TYPE = 0
