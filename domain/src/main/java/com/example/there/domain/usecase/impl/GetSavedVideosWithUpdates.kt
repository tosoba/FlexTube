...
class GetSavedVideosWithUpdates @Inject constructor(
        private val repository: IMainRepository
) : UseCase<List<String>, Flowable<List<PlaylistItem>>> {
    override fun execute(params: List<String>?): Flowable<List<PlaylistItem>> = repository.getSavedVideosWithUpdates(channelIds = params!!)
}